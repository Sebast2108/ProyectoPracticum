...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        @unless(Auth::user()->role === 'paciente')
    ...
    <div class="mb-3">
        <input type="text" id="searchInput" class="form-control" placeholder="Buscar pacientes por nombre, apellido, correo...">
    </div>

    {{-- Tabla responsiva --}}
    <div class="table-responsive">
        <table class="table table-hover align-middle" id="pacientesTable" data-sort-dir="asc">
            <thead class="table-dark">
                <tr>
                    ...
                    <th scope="col" style="cursor:pointer" onclick="sortTable(2)">ID Paciente <i class="bi bi-arrow-down-up"></i></th>
                    <th scope="col" style="cursor:pointer" onclick="sortTable(3)">Correo <i class="bi bi-arrow-down-up"></i></th>
                    <th scope="col" style="cursor:pointer" onclick="sortTable(4)">Historial Médico <i class="bi bi-arrow-down-up"></i></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('paciente.show', $p->id) }}" class="btn btn-info btn-sm" title="Ver">
                            <i class="bi bi-eye"></i>
                        </a>

                        {{-- Editar y Eliminar solo para admin y secretaria --}}
                        @if(in_array(Auth::user()->role, ['administrador', 'secretaria']))
                            <a href="{{ route('paciente.edit', $p->id) }}" class="btn btn-warning btn-sm" title="Editar">
...
<script>
    ...
    confirmDeleteModal.addEventListener('show.bs.modal', function (event) {
        ...
        var pacienteId = button.getAttribute('data-pacienteid');
        var form = document.getElementById('deleteForm');
        form.action = '/paciente/' + pacienteId;
    });
</script>
@endsection
